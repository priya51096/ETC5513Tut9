...
\caption{\label{tab:number-drug-off-table}Number of Drug Offences each Year}
\centering
\begin{tabular}[t]{r|r}
\hline
Year & Number\\
...
\begin{figure}
\centering
\includegraphics{Week8_demo_files/figure-latex/graph-drug-offences-1.pdf}
\caption{\label{fig:graph-drug-offences}Number of Drug Offences each Year}
\end{figure}
